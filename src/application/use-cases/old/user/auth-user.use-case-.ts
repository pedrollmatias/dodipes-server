...
// import { TokenHanlder } from '../../helpers/token-handler';
// import { UserRepository } from './user-repository';

// export interface IAuthUserUseCaseInput {
//   token?: string;
//   email: string;
//   name?: IName;
//   password?: string;
...
// export interface IAuthUserUseCaseOutput {
//   accessToken: string;
// }
...
//     tokenKey,
//   }: {
//     input: IAuthUserUseCaseInput;
//     tokenKey?: string | Buffer;
//   }): Promise<IAuthUserUseCaseOutput> {
//     const { email, password, name, avatar, token } = input;
...
//     name?: IName;
//     avatar?: string;
//   }): Promise<TInsertOutput> {
//     if (!email || !name) {
//       this.throwUnauthorizedError();
//     }

//     const now = new Date();
//     const user = await User.create({ data: { email, name: <IName>name, avatar, createdAt: now } });

//     return this.userRepository.insertOne(user.value);
//   }

//   private generateAccessToken({ payload }: { payload: { email: string; userId: unknown } }): string {
